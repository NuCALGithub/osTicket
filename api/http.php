...
$dispatcher = patterns('',
        ...
        url_get("^/tickets\.thread\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','threadGet')),
        ...
        url_get("^/sla\.(?P<format>xml|json|email)$", array('api.sla.php:SLAApiController','getSLA')),
        url_get("^/topic\.(?P<format>xml|json|email)$", array('api.topic.php:TopicApiController','getTopic')),
        url_get("^/staff\.get\.tickets\.(?P<format>xml|json|email)$", array('api.staff.php:StaffApiController','getStaffTickets')),
        url_get("^/staff\.get\.(?P<format>xml|json|email)$", array('api.staff.php:StaffApiController','getStaff')),
        url_get("^/staff\.get\.list\.(?P<format>xml|json|email)$", array('api.staff.php:StaffApiController','getAllStaff')),
        ...
        url_get("^/org\.get\.(?P<format>xml|json|email)$", array('api.org.php:OrgApiController','getOrg')),
