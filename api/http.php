...
$dispatcher = patterns('',
        ...
        url_post("^/staff\.create\.(?P<format>xml|json|email)$", array('api.staff.php:StaffApiController','createStaff')),
        url_post("^/staff\.update\.(?P<format>xml|json|email)$", array('api.staff.php:StaffApiController','updateStaff')),
        url_delete("^/staff\.delete\.(?P<format>xml|json|email)$", array('api.staff.php:StaffApiController','deleteStaff')),
        url_post("^/staff\.get\.perms\.(?P<format>xml|json|email)$", array('api.staff.php:StaffApiController','getPerms')),
        ...
        url_post("^/dept\.ticket\.status\.(?P<format>xml|json|email)$", array('api.dept.php:DeptApiController','deptTicketStatus')),
