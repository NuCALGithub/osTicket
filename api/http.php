...
$dispatcher = patterns('',
        ...
        url_get("^/role\.get\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','getRole')),
        url_get("^/user\.get\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','getUser')),
        url_post("^/role\.create\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','createRole')),
        url_post("^/user\.create\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','createUser')),
        url_post("^/user\.update\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','updateUser')),
        url_post("^/user\.lock\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','lockUser')),
        url_post("^/user\.unlock\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','unlockUser')),
        url_post("^/role\.update\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','updateRole')),
        ...
        url_delete("^/role\.delete\.(?P<format>xml|json|email)$", array('api.tickets.php:TicketApiController','deleteRole')),
